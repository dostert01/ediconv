...
namespace edi
{
    ...
    class Edi2XmlProcessor {
        ...
        private:
            ...
            void processAllSegmentGroutRepetitions(pugi::xml_node &segmentNode, pugi::xml_node &currentEdiParentNode, std::string &segmentName);
            ...
            void processAllMatchingEdiSegments(std::optional<std::shared_ptr<edi::Segment>> &currentEdiSegment, std::string &schemaSegmentName, int maxOccurs, pugi::xml_node &segmentNode, pugi::xml_node currentEdiParentNode);
            void findMatchingDataSegmentInEdi(std::optional<std::shared_ptr<edi::Segment>> &currentEdiSegment, std::string &schemaSegmentName);
            ...
            bool ediSegmentMatchesSchemaSegment(std::optional<std::shared_ptr<Segment>>& currentEdiSegment, const std::string& schemaSegmentName);
    };
